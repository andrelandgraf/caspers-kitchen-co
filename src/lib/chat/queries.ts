...
export async function ensureChatExists(
  ...
  // For anonymous users, allow access to any chat without userId
...
function parseMetadata(metadata: unknown): undefined {
  // Provider metadata is not persisted in the simplified schema
  // Return undefined to avoid type issues with SharedV3ProviderMetadata
