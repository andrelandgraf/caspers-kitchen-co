...
export const auth = betterAuth({
  ...
  emailAndPassword: {
    ...
    async sendResetPassword({ user, url }) {
      void sendEmail({
        to: user.email,
        subject: "Reset Your Caspers Kitchen Password",
  ...
  emailVerification: {
    ...
    async sendVerificationEmail({ user, url }) {
      void sendEmail({
        to: user.email,
        subject: "Verify your Caspers Kitchen email",
  ...
  user: {
    changeEmail: {
      ...
      async sendChangeEmailConfirmation({ user, newEmail, url }) {
        void sendEmail({
          to: user.email,
          subject: "Approve email change - Caspers Kitchen",
          react: (
            <ChangeEmail
    ...
    deleteUser: {
      ...
      async sendDeleteAccountVerification({ user, url }) {
        void sendEmail({
          to: user.email,
          subject: "Confirm account deletion - Caspers Kitchen",
          react: (
